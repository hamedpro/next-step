		...
		<div style={{ padding: "8px" }}>
			...
			<div style={{ padding: "4px" }}>
				...
				<p style={{ maxWidth: "500px", margin: "20px 0px" }}>
					This project is under heavy development. feel free to contact us if you have any
					suggestion or believe something has gone wrong.
				</p>
				<p style={{ maxWidth: "500px", margin: "20px 0px" }}>
					Also we're looking for <mark>Developers</mark> and <mark>Product Managers</mark>
					. take a look at our GitHub repository and join our journey!
				</p>
